 ...
 */
class DijetAngularAnalysisHists1: public uhh2::Hists {
public:
    // use the same constructor arguments as Hists for forwarding:
    DijetAngularAnalysisHists1(uhh2::Context & ctx, const std::string & dirname);

    virtual void fill(const uhh2::Event & ev) override;
    virtual ~DijetAngularAnalysisHists1();
